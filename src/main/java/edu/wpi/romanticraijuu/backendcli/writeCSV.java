...
public class writeCSV {
    ...
    Statement statement;
    public writeCSV(String filePathSlashFileNameWithoutDotCSV, Connection connection) throws SQLException {
    ...
    public void writeFromNode() throws SQLException, IOException {
        ...
        File csvFile = new File(filePathSlashFileNameWithoutDotCSV+".csv");
        FileWriter outputFileWriter = new FileWriter(csvFile);
        outputFileWriter.write("nodeID,xCoord,yCoord,longName,shortName,building,buildingFloor,nodeType");
        while(resultSet.next()){
            ...
            outputFileWriter.write("\n");
            outputFileWriter.write(aNodeID+","+anXCoord+","+aYCoord+","+aLongName+","+aShortName+","+aBuilding+","+aBuildingFloor+","+aNodeType);
        }
        outputFileWriter.flush();
        outputFileWriter.close();
    }
